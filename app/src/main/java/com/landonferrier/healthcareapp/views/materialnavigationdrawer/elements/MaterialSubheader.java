package com.landonferrier.healthcareapp.views.materialnavigationdrawer.elements;
...
//        params.setMargins(64,(int) (8 * density), 0 , (int) (8 * density));
...
//        Utils.setAlpha(text,0.54f);
        ...
        paramsText.setMargins((int) (72 * density),0, (int) (16 * density) , (int) (4 * density));
