package com.landonferrier.healthcareapp.views.materialnavigationdrawer;
...
import com.landonferrier.healthcareapp.views.materialnavigationdrawer.elements.listeners.MaterialAccountListener;
import com.landonferrier.healthcareapp.views.materialnavigationdrawer.elements.listeners.MaterialSectionListener;
import com.landonferrier.healthcareapp.views.materialnavigationdrawer.util.MaterialActionBarDrawerToggle;
import com.landonferrier.healthcareapp.views.materialnavigationdrawer.util.MaterialDrawerLayout;
import com.landonferrier.healthcareapp.views.materialnavigationdrawer.util.TypefaceManager;
import com.landonferrier.healthcareapp.views.materialnavigationdrawer.util.Utils;
...
//        }
        ...
        // INIT ACTION BAR
        toolbar.setBackground(getResources().getDrawable(R.drawable.actionbar_bg));
        this.setSupportActionBar(toolbar);
        actionBar = getSupportActionBar();
        actionBar.setBackgroundDrawable(getResources().getDrawable(R.drawable.actionbar_bg));
        RelativeLayout actionBarLayout = (RelativeLayout) getLayoutInflater().inflate(R.layout.action_bar_tile, null);
        ...
        if(Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
            ...
            if(!hasSavedInstanceState) {
                ...
                if (oldFragment != null && oldFragment != fragment)
                    ft.remove((androidx.fragment.app.Fragment) oldFragment);

                ft.replace(R.id.frame_container, (androidx.fragment.app.Fragment) fragment).commit();
            }
        }
...
//            statusBar.setImageDrawable(new ColorDrawable(sectionPrimaryColorDark));
        ...
        this.getToolbar().setBackgroundResource(R.drawable.actionbar_bg);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT)
            statusBar.setImageDrawable(new ColorDrawable(ContextCompat.getColor(getBaseContext(), R.color.colorPrimaryDark)));
    }
